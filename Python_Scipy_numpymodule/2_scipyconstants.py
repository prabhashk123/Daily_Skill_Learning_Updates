# scipy mainly used in scientific notation.(denote scientifically) eg:-Pi
# Constants in scipy :-Scipy is more focused on scientific im,plementataions, it provides many built in scientific constants: helpful in "data science ".

##Q. Printing the constant value of PI
from scipy import constants
print(constants.pi) 

##Q. Constant unit :- All list of the unit under the constant can be seen with dir() function.
from scipy import constants
print(dir(constants))  
