...
class Profile(BaseModel):
    ...
    # for count ke liye function step1 now base.html
...
# for function on cartitems for cart
...
def send_email_token(sender , instance , created , **kwargs):
    ...
    except BadHeaderError as h:
        print(h)
        print("Badheaders found")
